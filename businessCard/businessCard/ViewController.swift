...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        showContactButton.addTarget(self, action: #selector(showContacts), for: .touchUpInside)
        ...
        phoneLabel.textColor = #colorLiteral(red: 0.2392156869, green: 0.6745098233, blue: 0.9686274529, alpha: 1)
        phoneLabel.backgroundColor = #colorLiteral(red: 0.2392156869, green: 0.6745098233, blue: 0.9686274529, alpha: 1)
        ...
        emailLabel.textColor = #colorLiteral(red: 0.2392156869, green: 0.6745098233, blue: 0.9686274529, alpha: 1)
        emailLabel.backgroundColor = #colorLiteral(red: 0.2392156869, green: 0.6745098233, blue: 0.9686274529, alpha: 1)
    ...
    @objc func showContacts(sender: UIButton) {
        showContact.toggle()
        if(showContact) {
